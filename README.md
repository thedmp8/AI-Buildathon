...
The exchange finder searches ANU exchange program data extracted from `anu_programs.xlsx`.
...
The browser calls `/api/chat`; the server calls `https://api.openai.com/v1/responses`, so your API key stays server-side.
